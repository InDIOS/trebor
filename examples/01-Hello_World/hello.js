!function(root) {
  ...
  function _$tplHello(_$ctx) {
    var _b;
    var _$tpl, _$elements, _$h1_1, _$txt_1, _$setTxt_1;
    _$setTxt_1 = function(_$ctx) {
      return _$context(_$ctx, (function(_b) {
        return 'Hello, ' + _b[0] + '!';
      }), 'name');
    };
    _b = _$fragTpl('<h1 class="scope_79b73894"> </h1>'), _$tpl = _b[0], _$elements = _b.slice(1);
    return {
      $create: function() {
      ...
      $mount: function(parent, sibling) {
        this.$unmount();
        _$insertStyle('scope_79b73894', 'h1.scope_79b73894 {\n  color: red;\n}\n');
      ...
      $destroy: function() {
        ...
        _$removeStyle('scope_79b73894');
        _$tpl = _$elements = _$h1_1 = _$txt_1 = _$setTxt_1 = void 0;
      }
    };
  }
  root.Hello = _$createComponent(function() {
    function class_1() {
      this.name = 'World';
    }
    return class_1;
