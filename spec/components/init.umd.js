...
function _$tplInit(_$state) {
  var _$frag, h1_1, txt_1, setTxt_1;
  _$frag = _$d();
  setTxt_1 = function(_$state) {
    return 'Hello, ' + _$state.text + '!!';
  };
  return {
    $create: function() {
      h1_1 = _$ce('h1');
    ...
    $destroy: function() {
      ...
      delete _$state.$root;
      _$frag = h1_1 = txt_1 = setTxt_1 = void 0;
    }
  };
}
function Init(_$attrs, _$parent) {
  _$CompCtr.call(this, _$attrs, _$tplInit, {
    model: {
      text: 'World'
    }
  }, _$parent);
